  ...
  return (
    <div className='bg-primary w-full overflow-hidden'>
      ...
      <motion.div
        ...
        className="flex flex-col items-center justify-center h-1/4 text-white text-center py-8 bg-black-gradient-2 "
      >
        <h1 className="text-4xl font-semibold mb-4"><br/><br/>Our Blog</h1>
